    ...
    return (
        <div className="bg-white p-6 rounded-lg border">
            ...
            <div className="my-6 aspect-video bg-muted rounded-lg overflow-hidden">
                <img src={article.image_url || `https://via.placeholder.com/1200x675/cccccc/ffffff?text=Image+Placeholder`} alt={article.title} className="w-full h-full object-cover" />
            </div>
        ...
        <Card>
            ...
            <CardContent className="space-y-4">
                ...
                <div>
                    ...
                    <Badge variant="outline" className="mt-1">{article.status}</Badge>
                </div>
                <Separator />
...
export default function ReviewArtikel({ auth, article }) {
    return (
        <AdminLayout>
